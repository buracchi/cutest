...
function(cutest_discover_tests_impl)
    ...
    if (_TEST_FILTER)
        set(filter "--cutest_filter=${_TEST_FILTER}")
    else ()
        set(filter)
    endif ()
    ...
    execute_process(
            COMMAND ${_TEST_EXECUTOR} "${_TEST_EXECUTABLE}" --cutest_list_tests ${filter}
        ...
        if (NOT line MATCHES "cutest_main\\.c")
            ...
            if (NOT line MATCHES "^  ")
                ...
                if (NOT "${_TEST_XML_OUTPUT_DIR}" STREQUAL "")
                    set(TEST_XML_OUTPUT_PARAM "--cutest_output=xml:${_TEST_XML_OUTPUT_DIR}/${prefix}${suite}.${test}${suffix}.xml")
                else ()
